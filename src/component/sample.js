const sample = {
  ...
  dataFeed: [
    ...
    {
      id: 3,
      name: 'Rujak sayur dengan aroma terapi ',
      isExpanded: false,
    },
    {
      id: 4,
      name: 'Rujak buah dengan original pupuk',
      isExpanded: false,
    },
    {
      id: 5,
      name: 'Bakso jedor bikin tambah nyos',
      isExpanded: false,
    },
  ],
  data: [
